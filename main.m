...
hold on
pmedina =plot(snrOut,10*log10(crb_medina.tau), LineWidth=1.5);
hold on 
ptau = plot(snrOut,10*log10(crb_tau.tau), LineWidth=1.5);
hold on 
peta = plot(snrOut,10*log10(crb_eta.tau), LineWidth=1.5);
